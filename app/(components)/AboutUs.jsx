      ...
      <div >
        ...
        <div className="grid grid-cols-1 place-items-center p-10">
          ...
          <div className="p-6">
            ...
            <p className="text-gray-600 md:text-lg p-2">
              <span  className="font-semibold md:text-xl text-[#A9C274] tracking-wide ">Expertise:</span> At The Bulldog Babysitter, we're not just
              regular dog sitters. Our team has undergone specific training to
              understand the intricacies of bulldog care. From their dietary
              needs to their playful nature, we've got it all covered.
            </p>
            <p className="text-gray-600 md:text-lg p-2">
              <span  className="font-semibold md:text-xl text-[#A9C274] tracking-wide ">Facilities:</span> Nestled in [Location], our facility
              boasts spacious play areas, comfortable resting zones, and a
              health clinic specifically tailored for the well-being of
              bulldogs.
            </p>
            <p className="text-gray-600 md:text-lg p-2">
              <span  className="font-semibold md:text-xl text-[#A9C274] tracking-wide ">Love & Care:</span> Every bulldog that comes through our
              doors is treated like family. Our passionate team ensures that
              your furry friend receives not just the necessities but also an
              abundance of love and playtime.
            </p>
            <p className="text-gray-600 md:text-lg p-2">
              <span className="font-semibold md:text-xl text-[#A9C274] tracking-wide "> Holistic Approach:</span> We believe in a holistic approach
              to care. This includes regular exercise, balanced nutrition,
              social interaction, and even a bit of pampering!
            </p>
          </div>
        </div>
      </div>
...
//   <p className="text-gray-600 text-2xl p-4 font-light tracking-wide ">
//     Welcome to The Bulldog Babysitter, the ultimate haven for your beloved
//     bulldogs! Founded in 2015, we have dedicated ourselves to providing
//     specialized care exclusively for bulldogs. We understand the unique
//     charm of these stout, wrinkled-faced companions and recognize that their
//     distinctive physique and temperament require particular attention.
//   </p>
// </div>
